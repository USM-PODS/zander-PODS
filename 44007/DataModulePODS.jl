...
SeaPressureCol = Columns(:pr,"Sea Level Pressure","hPa",0.0,[9999.0], "Sea level pressure (hPa)", 30, [1000, 1200]) 
AirTempCol = Columns(:atmp,"Air Temperature","Celsius",0.0,[999.0], " ", 50, [-30, 70]) 
WaterTempCol = Columns(:wtmp,"Sea Surface Temperature","Celsius",0.0,[999.0], " ", 50, [-30, 70]) 
DewPointTempCol = Columns(:dew,"Dewpoint Temperature", "Celsius?",0.0,[999.0], "Dewpoint temperature taken at the same height as the air temperature measurement.", 50, [-30, 70]) 
